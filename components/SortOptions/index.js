...
const SortOptions = ({ sortOption, setSortOption,sort}) => 
  ...
  return (
    <div className="flex items-center justify-between bg-[#384068] px-6 py-4 rounded-xl h-fit w-full text-white">
      <div className="">
        <div className="flex items-center">
          <div className="flex items-center mr-9">
            ...
            <h1 className="font-bold text-lg ml-2">61 Suggestions</h1>
          </div>
          <Listbox
            value={sortOption}
            onChange={setSortOption}
          >
            <Listbox.Label className="text-small">Sort by:&nbsp;</Listbox.Label>
            <div className="relative flex items-center">
              <Listbox.Button className="flex items-center font-bold text-sm">
                {/* {selectedPerson.name}{' '} */}
                {sortOption?.name}{' '}
                <svg
                  width="1em"
                  ...
                  viewBox="0 0 9 7"
                  fill="none"
                  class="text-white ml-2 text-[.5rem]"
                >
                  <path
                    d="M1 1l4 4 4-4"
                    stroke="currentColor"
      ...
      <Link href="/new">
        <a className="flex items-center justify-center font-bold text-xs rounded-lg px-8 h-11 bg-[#ad20ea]">
          + Add Feedback
        </a>
      </Link>
    </div>
